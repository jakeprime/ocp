...
module Ocp
  class GitClient
    ...
    def initialize
      raise 'No GITHUB_TOKEN env var found' unless ENV.key?('GITHUB_TOKEN')
    ...
    def commit_message
      <<~MESSAGE
        ...
        OCP has merged the branch #{branch}
    ...
    def git_event
      raise 'No GITHUB_EVENT env var found' unless ENV.key?('GITHUB_EVENT')
